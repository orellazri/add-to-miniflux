# Add to Miniflux Chrome Extension Privacy Policy

**Last updated:** July 5, 2026

## Overview

The Add to Miniflux Chrome extension is a companion tool for self-hosted Miniflux instances. It lets users discover feeds from the current browser tab and add selected feeds to their own Miniflux server.
